...
// $this->sections[] = array(
            ...
            //     'title'  => esc_html__( 'Demo Content', 'nastik' ),
            //     'desc'   => esc_html__( 'Description Goes Here', 'nastik' ),
...
if ( !function_exists( 'wbc_importer_description_text' ) ) {
	...
	function wbc_importer_description_text( $description ) {
		...
		$message = '<p>'. esc_html__( 'Best if used on new WordPress install.', 'nastik' ) .'</p>';
		$message .= '<p>'. esc_html__( 'Images are for demo purpose only.', 'nastik' ) .'</p>';
