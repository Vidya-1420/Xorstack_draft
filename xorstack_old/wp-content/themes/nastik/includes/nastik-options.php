    ...
    // ACTUAL DECLARATION OF SECTIONS
				...
				Redux::setSection( $opt_name, array(
					...
					array(
							...
							'subtitle' => esc_html__( '', 'nastik' ),
							'desc'     => __( 'e.x: &lt;li&gt;&lt;a target="_blank" href="#"&gt;&lt;i class="fab fa-facebook-f"&gt;&lt;/i&gt;&lt;/a&gt;&lt;/li&gt;<br>Use <a href="https://fontawesome.com/icons?d=listing" target="_blank">Fontawesome</a> Icon Class', 'nastik' ),
							'required' => array('social_show_hide_opt_head', '=' , 'st2')
					),
				...
				Redux::setSection( $opt_name, array(
                    ...
                    'fields' => array(  
						...
						array(
                            ...
                            'google'      => true, 
                            'font-backup' => false,
                            'output'      => array('p, .main-about-text-area'),
                            'units'       =>'px',
							'line-height'       =>false,
