 ...
 * @since 1.0.0
 */
class Zonar_Call_To extends Widget_Base {
	...
	public function get_title() {
		return __( 'Zonar Call To Action', 'zonar-plugin' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default' => 'Ready to order your project ? Visit my contacts page',
			]
		);
		...
		$this->add_control(
			'button_target',
			[
				'label' => __( 'Button Target', 'xpider-ts' ),
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .srv-link-text h4' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .srv-link-text h4',
			]
		);
		$this->end_controls_section();
		...
		$this->add_control(
			'section_button_title_color_hover',
			[
	...
	protected function render() {
		...
		<a href="<?php echo esc_url($settings['button_url']); ?>" class="btn  color-bg  fl-btn" target="<?php echo esc_attr($settings['button_target']); ?>"><span><?php echo esc_html($settings['button_title']); ?></span></a>
