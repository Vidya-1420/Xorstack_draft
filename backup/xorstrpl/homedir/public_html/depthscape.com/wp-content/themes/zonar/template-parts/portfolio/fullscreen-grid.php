...
<!-- content-->    
                <div class="content" data-pagetitle="<?php echo wp_trim_words(get_the_title(), 3, '..');?>">
                    ...
                    <!-- portfolio start -->
                    <div class="gallery-items gallery-items_fs <?php if(get_post_meta($post->ID,'rnr_zo_port_pages_column_full',true)=='st2'){ ?>three-column <?php } else if(get_post_meta($post->ID,'rnr_zo_port_pages_column_full',true)=='st3'){?>two-column <?php } else { ?>four-column<?php } ;?>  fl-wrap  " id="port-scroll">
                        ...
                        <!-- gallery-item-->
                        <div class="gallery-item  <?php echo esc_attr($zonar_class);?> <?php if (( get_post_meta($post->ID,'rnr_post-box-width',true))=='portfolio_item_second'):?>gallery-item-second<?php else : ?><?php endif;?>">
