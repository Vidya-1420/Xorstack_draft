...
<!-- content-->    
                <div class="content" data-pagetitle="<?php echo wp_trim_words( get_the_title(), 3 ); ?>">
                    ...
                    <div class="fixed-column-wrap">
                        ...
                        <?php $zonar_back_images = rwmb_meta( 'rnr_zo_page_post_dt_block_right_image','type=image&size=' ); ?>
						...
						<?php } ;?>
						<?php } else { ?>
						<div class="bg"  data-bg="<?php echo esc_url(Zonar_AfterSetupTheme::return_thme_option('post_details_back','url'));?>"></div>
						<?php } ;?>
                            ...
                            <div class="fixed-column-wrap_title first-tile_load">
                                <h2>
								<?php if (( get_post_meta($post->ID,'rnr_zo_page_post_dt_header_title_opt',true))):?>
								<?php echo  do_shortcode(get_post_meta($post->ID,'rnr_zo_page_post_dt_header_title_opt',true)); ?>
								<?php else: ?>
								<?php if(!empty($zonar_options['blogtitle'])):?><?php echo esc_attr(Zonar_AfterSetupTheme::return_thme_option('blogtitle',''));?><?php else :?><?php esc_html_e('My Blog','zonar');?><?php endif;?>
								<?php endif;?>
								</h2>
                                <?php if (( get_post_meta($post->ID,'rnr_zo_page_post_dt_header_sub_title_opt',true))):?>	
                                <p><?php echo esc_html(get_post_meta($post->ID,'rnr_zo_page_post_dt_header_sub_title_opt',true)); ?>  </p>
								<?php endif;?>
                            </div>
