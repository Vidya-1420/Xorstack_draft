 ...
 <!--content -->
                    <div class="content">
                        ...
                        <section class="header-section hidden-section" data-scrollax-parent="true">
                            <div class="bg par-elem"  data-bg="<?php echo esc_url($zonar_image[0]);?>" data-scrollax="properties: { translateY: '30%' }"></div>
                            ...
                            <div class="container">
                                ...
                                <div class="scroll-down-wrap hiddec-anim">
                                    ...
                                    <span><?php if(get_post_meta($post->ID,'rnr_ns_page_header_translate_opt',true)):?><?php echo esc_html(get_post_meta($post->ID,'rnr_ns_page_header_translate_opt',true));?> <?php else : ?><?php esc_html_e('Scroll down  to discover','zonar');?><?php endif;?></span>
                                </div>
                            </div>
                        ...
                        <section class="no-bottom-padding">
							...
							<?php } ;?>
									...
									$zonar_content_div_class="container-disable";
									} else {
							...
							$zonar_buton_class="ajax";
								...
								<?php if (( get_post_meta($post->ID,'rnr_ns_page_call_to_button',true))):?>
                                    <div class="order-wrap-container fl-wrap">
                                        ...
                                        <a href="<?php echo esc_url(get_post_meta($post->ID,'rnr_ns_page_call_to_button',true)); ?>" class="<?php echo sanitize_html_class($zonar_buton_class);?> btn color-bg"><?php echo esc_html(get_post_meta($post->ID,'rnr_ns_page_call_to_text',true)); ?></a>
                                    </div>
									<?php endif;?>
                                </div>
                            </div>
